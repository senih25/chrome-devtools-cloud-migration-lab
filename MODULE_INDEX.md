...
| 06 | `module-06-cloud-run` | Next | Research candidate | Cloud Run deployment evidence | Network, Performance, Security | Cloud Run | Medium | `docs/modules/module-06-cloud-run/` | Serverless deployment proof | Needs manual review |
