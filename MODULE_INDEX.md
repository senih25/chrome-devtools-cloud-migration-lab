...
| 03 | `module-03-cloud-datastore` | Now | Official Google codelab / implementation planning | Cloud NDB to Cloud Datastore migration | Network, Console, Application, Security | App Engine, Cloud Datastore | Medium | `docs/modules/module-03-cloud-datastore/` | Datastore client migration module | Needs manual review |
